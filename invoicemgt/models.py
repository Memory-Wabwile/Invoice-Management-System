...
class Invoice(models.Model):
	...
	line_six = models.CharField('Line 1', max_length=120, default='', blank=True, null=True)
	...
	line_seven = models.CharField('Line 2', max_length=120, default='', blank=True, null=True)
	...
	line_eight = models.CharField('Line 3', max_length=120, default='', blank=True, null=True)
	...
	line_nine = models.CharField('Line 4', max_length=120, default='', blank=True, null=True)
	...
	line_ten = models.CharField('Line 5', max_length=120, default='', blank=True, null=True)
